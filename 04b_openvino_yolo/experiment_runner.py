...
for model in yolo_models:
    ...
    # Replace this with actual code to feed data
    print("Feeding data to the application...")
    time.sleep(30)

    # Simulate waiting for the application to process all data
    # Replace this with actual code to check processing status
    print("Waiting for the application to process all data...")
    time.sleep(1800)  # 30 minutes

    # Simulate extracting experiment data
    # Replace this with actual code to extract data
    print(f"Extracting data for YOLO_MODEL={model}...")
